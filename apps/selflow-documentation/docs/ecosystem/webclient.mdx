...
To use it you can build it ! You only need to have a [node.js](https://nodejs.org/en) environment, [yarn](https://yarnpkg.com/getting-started/install) installed, [git](https://git-scm.com/downloads) and [docker](https://docs.docker.com/engine/install/).
...
yarn nx run webclient:docker

## Run the docker image
docker run -d -p 3000:3000 -e "DAEMON_URL=selflow-daemon:10011" --network selflow-daemon selflow-webclient
```
